...
sudo -u logstash gem install logstash-input-azure_blob_storage-0.11.3.gem
pushd /usr/share/logstash 
/usr/share/logstash/bin/logstash-plugin install /usr/src/logstash-input-azure_blob_storage/logstash-input-azure_blob_storage-0.11.3.gem
popd
